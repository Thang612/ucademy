...
const CourseUpdate = ({ data }: { data: ICourse }) => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (values.slug && values.slug !== data.slug) {
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <>
                                        <div className="h-[200px] bg-white rounded-md border border-gray-200 flex items-center justify-center relative overflow-hidden">
                                            {!imgWatch ? (
                                                <UploadButton
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent className="bg-white dark:bg-grayDarker">
                                            <SelectGroup >
